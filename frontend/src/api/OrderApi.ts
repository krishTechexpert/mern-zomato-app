...
export const useGetMyOrders = () => {
  ...
  const {data:orders,isLoading} = useQuery("fetchMyorders",getMyOrderRequest,{
...
export const useCreateCheckoutSession = () => {
  ...
  //Unlike useQuery, which is used for fetching data (GET requests), useMutation focuses on operations such as POST, PUT, PATCH, or DELETE requests that mutate data.
